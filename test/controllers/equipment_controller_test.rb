...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { brand: @equipment.brand, price: @equipment.price, reference: @equipment.reference, type: @equipment.type }
    end
  ...
  test "should update equipment" do
    patch :update, id: @equipment, equipment: { brand: @equipment.brand, price: @equipment.price, reference: @equipment.reference, type: @equipment.type }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
