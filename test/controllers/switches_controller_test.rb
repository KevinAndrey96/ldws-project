...
class SwitchesControllerTest < ActionController::TestCase
  ...
  test "should create switch" do
    assert_difference('Switch.count') do
      post :create, switch: { name: @switch.name, nports: @switch.nports, port: @switch.port, price: @switch.price, reference: @switch.reference }
    end
  ...
  test "should update switch" do
    patch :update, id: @switch, switch: { name: @switch.name, nports: @switch.nports, port: @switch.port, price: @switch.price, reference: @switch.reference }
    assert_redirected_to switch_path(assigns(:switch))
  end
