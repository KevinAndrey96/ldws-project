...
class BuildingsControllerTest < ActionController::TestCase
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post :create, building: { distance: @building.distance, name: @building.name, request_id: @building.request_id }
    end
  ...
  test "should update building" do
    patch :update, id: @building, building: { distance: @building.distance, name: @building.name, request_id: @building.request_id }
    assert_redirected_to building_path(assigns(:building))
  end
